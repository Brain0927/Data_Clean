...
def ML_read_dataframe(df, featuresCol, labelCol,num1):
    ...
    print(y, "外型大小")  # 印出結果
    train_x, test_x, train_y, test_y = train_test_split(x, y, test_size=num1)
    return train_x, test_x, train_y, test_y

def ML_read_dataframe_標準化(fileName, featuresCol, labelCol,df):
